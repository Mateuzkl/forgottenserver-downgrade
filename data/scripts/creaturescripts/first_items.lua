...
function mainFirstItems.onLogin(player)
    ...
    for i = 1, #targetVocation.container do
        player:addItem(1988, 1):addItem(targetVocation.container[i][1], targetVocation.container[i][2])
    end
    return true
end
