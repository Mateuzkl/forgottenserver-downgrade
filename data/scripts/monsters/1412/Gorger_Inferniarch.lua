...
monster.outfit = { lookType = 1797 }

monster.health = 9450
monster.maxHealth = 9450
monster.runHealth = 0
monster.race = "undead"
monster.corpse = 55001
monster.speed = 320
monster.manaCost = 0
...
monster.loot = {
	{ id = 2152, chance = 16500, maxCount = 40 },
	{ id = 54900, chance = 1000, maxCount = 1 },
	{ id = 2146, chance = 12500, maxCount = 5 },
	{ id = 55050, chance = 9300, maxCount = 1 },
	{ id = 7452, chance = 14500, maxCount = 1 },
	{ id = 54899, chance = 1500, maxCount = 1 },
	{ id = 54885, chance = 1000, maxCount = 1 },
	{ id = 7452, chance = 14500, maxCount = 1 },
	{ id = 2169, chance = 5000, maxCount = 1 }, -- Time ring
	{ id = 2157, chance = 5000, maxCount = 1 }, -- gold nugget
	{ id = 2209, chance = 5000, maxCount = 1 }, -- club ring
