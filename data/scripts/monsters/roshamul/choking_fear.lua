...
monster.attacks = {
	...
	{ name = "condition", interval = 2000, chance = 100, target = false, condition = { type = CONDITION_POISON, startDamage = 0, tick = 8000, minDamage = -700, maxDamage = -900, length = 5, spread = 0, effect = CONST_ME_HITBYPOISON } },
